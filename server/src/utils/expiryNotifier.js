...
const buildMessage = (name, daysLeft, expiryDateStr) => {
	...
	return `Hi ${firstName}, your membership at *Login Sports Academy* is expiring soon. 📅 Please contact us to renew and continue your training! 💪✨`;
};

...
const Shop = () => {
  ...
  return (
    <div style={{ fontFamily: "Poppins, system-ui, -apple-system, sans-serif", overflowX: "hidden" }}>
      ...
      <Navbar />
      {/* ===================== HERO ===================== */}
      <section className="premium-bg-hero premium-section" style={{ color: "white", display: "flex", alignItems: "center", position: "relative", minHeight: "auto", overflow: "hidden" }}>
        ...
        <div className="container container pb-lg-5 pb-0 ">
          <div className="row align-items-center g-5">
            <div className="col-lg-6" data-aos="fade-right" data-aos-delay="100">
              ...
              >
                Login Sports Academy <span style={{ color: "#FFE66D" }}>Shop</span>
              </h1>
      ...
      <section className="py-5" style={{ background: "#0a0e1a" }}>
            ...
            return (
              <div key={key} className="category-section" data-aos="fade-up" data-aos-delay={categoryIndex * 200}>
                ...
                <div className="category-header">
                  ...
                  <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "1.1rem", fontWeight: "500", margin: 0 }}>
                ...
                <Slider {...carouselSettings}>
                  ...
                  (imagePath, i) => {
                    return (
                      <div key={i}>
                        <div 
                          className="premium-glass premium-glass-hover h-100"
                          style={{
      ...
      {/* ===================== WHY CHOOSE US ===================== */}
      <section className="premium-bg-swimming premium-section" style={{ position: "relative", color: "white" }}>
        <div className="premium-overlay"></div>
        <div className="container py-5">
          <div className="text-center mb-5" data-aos="fade-up">
            <h2 className="fw-bold" style={{ fontSize: "2.8rem", marginBottom: "1rem", color: "#fff" }}>
              Why Choose Login Sports Academy Shop
            </h2>
          </div>
            ...
            (item, i) => {
              return (
                <div className="col-md-6 col-lg-3" key={i} data-aos="zoom-in" data-aos-delay={i * 100}>
                  <div className="premium-glass premium-glass-hover"
                    style={{
                      padding: "30px",
      ...
      {/* ===================== CTA ===================== */}
      <section className="text-center position-relative overflow-hidden py-5" style={{ background: "#0a0e1a", color: "white" }}>
        <div className="container position-relative py-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <p className="lead mb-4" style={{ opacity: 0.85, color: "rgba(255,255,255,0.7)", fontSize: "1.1rem", fontWeight: "500" }}>
